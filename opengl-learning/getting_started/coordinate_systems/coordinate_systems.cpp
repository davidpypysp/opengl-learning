...
int main()
{
	...
	Shader ourShader("getting_started/coordinate_systems/coordinate_systems.vert", "getting_started/coordinate_systems/coordinate_systems.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 projection;
		projection = glm::perspective(glm::radians(mixValue), (float)(WIDTH) / (float)HEIGHT, 0.1f, 100.0f);
