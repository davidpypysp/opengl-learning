...
int main()
{
	...
	Shader lightingShader("lighting/basic_lighting/lighting.vert", "lighting/basic_lighting/lighting.frag");
	Shader lampShader("lighting/basic_lighting/lamp.vert", "lighting/basic_lighting/lamp.frag");
