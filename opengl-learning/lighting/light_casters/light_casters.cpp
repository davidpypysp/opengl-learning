...
int main()
{
	...
	Shader lightingShader("lighting/light_casters/lighting.vert", "lighting/light_casters/lighting.frag");
	Shader lampShader("lighting/light_casters/lamp.vert", "lighting/light_casters/lamp.frag");
