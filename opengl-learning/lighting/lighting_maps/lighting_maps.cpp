...
int main()
{
	...
	Shader lightingShader("lighting/lighting_maps/lighting.vert", "lighting/lighting_maps/lighting.frag");
	Shader lampShader("lighting/lighting_maps/lamp.vert", "lighting/lighting_maps/lamp.frag");
