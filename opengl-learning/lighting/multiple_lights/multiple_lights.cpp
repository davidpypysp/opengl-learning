...
int main()
{
	...
	Shader lightingShader("lighting/multiple_lights/lighting.vert", "lighting/multiple_lights/lighting.frag");
	Shader lampShader("lighting/multiple_lights/lamp.vert", "lighting/multiple_lights/lamp.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (int i = 0; i < 4; i++) {
			...
			glUniform3f(glGetUniformLocation(lightingShader.Program, ("pointLights[" + std::to_string(i) + "].diffuse").c_str()), 0.8f, 0.8f, 0.8f);
			...
			glUniform1f(glGetUniformLocation(lightingShader.Program, ("pointLights[" + std::to_string(i) + "].linear").c_str()), 0.09);
			glUniform1f(glGetUniformLocation(lightingShader.Program, ("pointLights[" + std::to_string(i) + "].quadratic").c_str()), 0.032);
		}
